...
<body class="theme-cyan login-page authentication">
  ...
  <?php
    if(isset($_POST['username'])){
      ...
      $reqTestExistEmail="select * from cabinet where EMAIL='".$LOGIN."' and MOTDEPASSE='".$MOTDEPASSE."'";
  ...
  if(mysqli_num_rows($queryTestExistEmail)!=0){
    ...
    {
      $IDUTILISATEUR 	= $enregTestExistEmail['EMAIL'];
      $MDPUTILISATEUR = $enregTestExistEmail['MOTDEPASSE'];
      $ID             = $enregTestExistEmail['id'];
    }
      $_SESSION['User'] = $IDUTILISATEUR;
      $_SESSION['Password'] = $MDPUTILISATEUR;
      $_SESSION['ID'] = $ID;

    echo '<SCRIPT LANGUAGE="JavaScript">document.location.href="rdv.php" </SCRIPT>';
...
<div class="container">
    ...
    <div class="card">
        <h1 class="title"><span>Hoppharm</span>Login <span class="msg">Connection en tant que Medecin</span></h1>
        <div class="col-md-12">
            <form action="" method="POST">
              ...
              <?php }elseif ($_GET['err']==1) {?>
                <h1 class="h1 caption" style="color:red;    font-size: 17px;">Medecin non enregistrer dans la base ! &nbsp;</h1><br /><br />
            <?php  }elseif ($_GET['err']==2) {?>
              <h1 class="h1 caption" style="color: #3CB371;    font-size: 17px;">Mot De Passe modifier! &nbsp;</h1><br /><br />
          <?php  }
							       } ?>
